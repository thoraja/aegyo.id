        ...
        <div class="w-1/2 bg-white rounded overflow-hidden shadow-lg py-3 px-5">
            <form action="{{ route('categories.update', $category) }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="name" type="text" placeholder="Category Name" name="name" required value="{{ $category->name }}">
                </div>
